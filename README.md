...
2. [**TP2 – Clustering**](IA%20pr%C3%A9dictive/TP2_Clustering/TP2_Clustering_Enonce.md) : mise en œuvre d'algorithmes de regroupement non supervisé (k-means, analyse visuelle de l'inertie, etc.). ([English version](IA%20pr%C3%A9dictive/TP2_Clustering/TP2_Clustering_Enonce_EN.md)) ➡️ [Version avancée](IA%20pr%C3%A9dictive/TP2_Clustering/TP2_Clustering_Avance_Enonce.md) ([English version](IA%20pr%C3%A9dictive/TP2_Clustering/TP2_Clustering_Avance_Enonce_EN.md))
   - [**TP2bis – Réduction de dimension**](IA%20pr%C3%A9dictive/TP2_Clustering/TP2bis_Reduction_Dimension_Enonce.md) : PCA, t-SNE, UMAP, LDA et autres techniques de visualisation haute dimension. ([English version](IA%20pr%C3%A9dictive/TP2_Clustering/TP2bis_Reduction_Dimension_Enonce_EN.md))
3. [**TP3 – Classification supervisée**](IA%20pr%C3%A9dictive/TP3_Classification/TP_Classification_Apprentissage_Supervise_Enonce_v3.md) : application d'algorithmes de classification et évaluation des performances. ([English version](IA%20pr%C3%A9dictive/TP3_Classification/TP_Classification_Apprentissage_Supervise_Enonce_v3_EN.md))
4. [**TP4 – XGBoost avancé**](IA%20pr%C3%A9dictive/TP4_XGBoost/TP4_XGBoost_Avance.md) : découverte et paramétrage d'un modèle de gradient boosting pour la classification. ([English version](IA%20pr%C3%A9dictive/TP4_XGBoost/TP4_XGBoost_Avance_EN.md))
5. [**TP5 – Régression**](IA%20pr%C3%A9dictive/TP5_Regression/TP5_Regression_Validation.md) : mise en place d'un pipeline de régression et analyse des métriques associées. ([English version](IA%20pr%C3%A9dictive/TP5_Regression/TP5_Regression_Validation_EN.md))
6. [**TP6 – Séries temporelles**](IA%20pr%C3%A9dictive/TP6_Series_Temporelles/TP6_Series_Temporelles_Index.md) : parcours guidé (exploration, stationnarité, AR/ARIMA, modèles supervisés). ([English version](IA%20pr%C3%A9dictive/TP6_Series_Temporelles/TP6_Series_Temporelles_Index_EN.md))
7. [**TP7 – Objectifs et métriques XGBoost**](IA%20pr%C3%A9dictive/TP7_XGBoost_Objectifs_Metriques/TP7_XGBoost_Objectifs_Metriques.md) *(facultatif)* : exploration d'objectifs personnalisés et des métriques avancées pour XGBoost. ([English version](IA%20pr%C3%A9dictive/TP7_XGBoost_Objectifs_Metriques/TP7_XGBoost_Objectifs_Metriques_EN.md))
